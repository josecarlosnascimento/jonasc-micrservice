...
import br.com.nascar.repository.CambioRepository;
...
public class CambioController {
	...
	@Operation(description = "Find a cambio from currency!")
	...
	public Cambio getCambio(@PathVariable("amount") BigDecimal amount, @PathVariable("from") String from, @PathVariable("to") String to) {
		...
		return new Cambio(1L, cambio.getFrom(), cambio.getTo(), conversionFactory, convertedValue, cambio.getEnvironment());
	}
